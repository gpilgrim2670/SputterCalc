#' SAngle
#'
#' @description Calculates the angle between the ray and the source normal
#'
...
SAngle <- function(Disc_1 = -5,
  ...
  # Calculates the S angle.  Var1 is Radius from above, Var1 is Angle
  SAngle <- sqrt((X - gr$Var2 * sin(gr$Var1))^2 + (Y - p)^2 + (Z - gr$Var2 * cos(gr$Var1))^2)
